 ...
 */
export function makeMathNumber(number) {
 ...
 */
export function simpleBlock(block_type) {
 ...
 *     generate the specified block.
 */
export function repeatSimpleBlock(count) {
 ...
 */
export function makeTestsFromBuilderRequiredBlocks(customRequiredBlocks) {
 ...
 * @param blockB
 */
export function blocksMatch(blockA, blockB) {
 ...
 * @param blockB
 */
export function blockTitlesMatch(blockA, blockB) {

 ...
 * @constructor
 */
var JsDebuggerUi = function (runApp) {
  /**
...
export default JsDebuggerUi;

import jsDebuggerHtml from './JsDebuggerUi.html.ejs';
...
import jsDebuggerWatchItem from './JsDebuggerWatchItem.html.ejs';
  ...
  if (jsInterpreter) {
    ...
    for (var watchExpression in this.watchExpressions_) {
      ...
      if (debugWatchDiv) {
        ...
        watchItem.innerHTML = jsDebuggerWatchItem({

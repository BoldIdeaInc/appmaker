...
import shareFailureHtml from './templates/shareFailure.html.ejs';
...
FeedbackUtils.prototype.getShareFailure_ = function (options) {
  ...
  shareFailureDiv.innerHTML = shareFailureHtml({
...
import sharingHtml from './templates/sharing.html.ejs';
...
FeedbackUtils.prototype.createSharingDiv = function (options) {
  ...
  sharingDiv.innerHTML = sharingHtml({
    options: options
  });
